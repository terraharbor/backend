...
def _versioned_state_info_path(project_id: int, state_name: str, version: int) -> str:
    return os.path.join(_state_dir(project_id, state_name), f"{version}.tfstate.meta")
